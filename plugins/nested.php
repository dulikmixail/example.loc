...
// PHPC Online Plugin - Nested Set v1.0  by Antylevsky Aleksei (Next)
...
class NestedSet
{
  ...
  function NestedSet($table, $autoOrder=false, $enablePaths=false)
  {
    $this->table=$table;
  ...
  function internalGetTree($check=false)
  {
    ...
    $this->tree=$database->getOrderedLines($this->table,$order);
  ...
  function cleanup()
  {
    ...
    $database->modifyLines($this->table,$values);
    $this->tree=false;
  }
